...
import { sendOtpToPhoneNumber, verifyOtp as verifyTwilioOtp } from "../services/twilio.service.js";
...
const checkAuthenticated = async (req, res) => {
  try {
    ...
    return response(res, 200, 'user retrived and allowed to user whatsapp', user)
  } catch (error) {
    return response(res, 500, error.message || 'Internal server Error')
  }
}
...
export { sendOTP, verifyOtp, updateProfile, checkAuthenticated, logout, getAllUsers }
