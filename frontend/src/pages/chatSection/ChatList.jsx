...
const ChatList = ({ contacts }) => {
  ...
  return (
    ...
    >
      <div
        className={`p-4 flex justify-between ${theme === 'dark' ? 'text-white' : 'text-grey=800'}`}
      >
      ...
      <div className="p-2">
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none  focus:ring-2 focus:ring-purple-500 ${theme === 'dark' ? 'bg-gray-800 text-white border-gray-700 placeholder:bg-gray-500' : 'bg-gray-100 text-black border-gray-200 placeholder-gray-400'}`}
            value={searchTerms}
